...
const CONFIG = {
    ...
    startUrl: 'http://tw.news.yahoo.com/',
...
5.  \`"detailedSummary"\`: (string) 撰写一篇详尽、流畅、结构清晰的深度摘要（约200-800字）,如果原文文章比较长,字数也可以适度增加,如果原文存在报道媒体,时间,地点,人物(主体),事件这些重要信息,一定要包含进去(无需严格格式化报道媒体时间地点人物事件)，可使用Markdown换行符 \`\\n\` 和列表来增强可读性。
